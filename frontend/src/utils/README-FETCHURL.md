...
VITE_PROD_API_URL=https://samuhlagna-production.up.railway.app
```
...
// await axios.get("https://samuhlagna-production.up.railway.app/user_data/");
...
- **Production**: Uses `VITE_PROD_API_URL` (default: https://samuhlagna-production.up.railway.app)
